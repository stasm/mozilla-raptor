...
Reboot.prototype.waitForHomescreen = function() {
  return this.waitForMark('fullyLoaded', VERTICAL_CONTEXT);
};

Reboot.prototype.waitForSystem = function() {
  return this.waitForMark('fullyLoaded', SYSTEM_CONTEXT);
};
  ...
  return new Promise(function(resolve) {
    ...
    runner
      ...
      .then(function() {
        ...
        Promise
          .all([
            runner.waitForHomescreen(),
            runner.waitForSystem()
          ])
          .then(function() {
