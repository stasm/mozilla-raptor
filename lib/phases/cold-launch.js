...
ColdLaunch.prototype.getAppCoordinates = function() {
  ...
  var selector = '#icons > .icon[data-identifier*="' + this.options.app + '"]';
  ...
  return marionette
    ...
    .then(function(client) {
      ...
      // We need the difference between the Ssytem and Homescreen to determine
    ...
    .then(function(icon) {
      ...
      phase.appX = Math.ceil((icon.rect.left + 20) * dpx);
      phase.appY = Math.ceil((icon.rect.top + 20 + icon.systemOffset) * dpx);
