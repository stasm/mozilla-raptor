...
Phase.prototype.format = function(entries, startMark) {
  ...
  var revisionId = this.getRevisions().revisionId;
  var testTags = merge({
...
Phase.prototype.annotate = function() {
  ...
  gaia.fields.revisionId = revisions.revisionId;
  gecko.fields.revisionId = revisions.revisionId;
